...
https://projects.spring.io/spring-framework/[Spring Framework] 4.2 and is
by default built against https://hadoop.apache.org/[Apache Hadoop] 2.7.1.

Spring for Apache Hadoop supports the following versions and
distributions:

* https://hadoop.apache.org/[Apache Hadoop] 2.7.1
* https://hadoop.apache.org/[Apache Hadoop] 2.6.0
* https://www.pivotal.io/[Pivotal] HD 2.1
* https://www.pivotal.io/[Pivotal] HD 3.0
* https://www.cloudera.com/[Cloudera] CDH5
* https://www.hortonworks.com/[Hortonworks] Data Platform 2.3 and 2.4
...
https://hbase.apache.org/[HBase] 0.94.11, https://hive.apache.org/[Hive]
0.11.0 (As of version 2.3.0 we only support HiveServer2 using the JDBC driver) 
and https://pig.apache.org/[Pig] 0.11.0 and above. As a rule of
...
https://hadoop.apache.org/common/docs/stable/#Getting+Started[Getting
...
project features.
* _Spring Data
https://shop.oreilly.com/product/0636920024767.do[Book]_. +
...
https://creativecommons.org/about[Creative Commons] organization.
* _Spring Data Book
