...
https://projects.spring.io/spring-framework/[Spring Framework] 4.3 and is
by default built against https://hadoop.apache.org/[Apache Hadoop] 2.7.3.

Spring for Apache Hadoop supports the following versions and
distributions:

* https://hadoop.apache.org/[Apache Hadoop] 2.7.3
* https://hadoop.apache.org/[Apache Hadoop] 2.6.3
* https://www.pivotal.io/[Pivotal] HD 3.0
* https://www.cloudera.com/[Cloudera] CDH5
* https://www.hortonworks.com/[Hortonworks] Data Platform 2.5 and 2.4
