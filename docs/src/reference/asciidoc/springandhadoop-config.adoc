...
<beans xmlns="http://www.springframework.org/schema/beans"
   ...
   xsi:schemaLocation="
    ...
    https://www.springframework.org/schema/hadoop/spring-hadoop.xsd"><!--3-->
...
https://docs.spring.io/spring/docs/4.1.x/spring-framework-reference/html/expressions.html[SpEL]
and the
