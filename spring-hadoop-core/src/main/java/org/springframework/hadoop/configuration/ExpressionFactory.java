...
import org.springframework.hadoop.annotation.Key;
import org.springframework.hadoop.annotation.Mapper;
import org.springframework.hadoop.annotation.Reducer;
import org.springframework.hadoop.annotation.Value;
import org.springframework.hadoop.annotation.Values;
import org.springframework.hadoop.util.reflect.ParameterAction;
import org.springframework.hadoop.util.reflect.AllParameters;
import org.springframework.hadoop.util.reflect.AnnotatedParameters;
import org.springframework.hadoop.util.reflect.FirstParameter;
import org.springframework.hadoop.util.reflect.ParameterMatcher;
import org.springframework.hadoop.util.reflect.MethodUtils;
import org.springframework.hadoop.util.reflect.ParameterRule;
import org.springframework.hadoop.util.reflect.ParameterRules;
import org.springframework.hadoop.util.reflect.SimpleRule;
import org.springframework.hadoop.util.reflect.SingleParameter;
import org.springframework.hadoop.util.reflect.TypedParameters;
