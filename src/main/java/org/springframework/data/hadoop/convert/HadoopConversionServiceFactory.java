...
import org.springframework.data.hadoop.convert.support.BooleanBooleanWritableConverter;
import org.springframework.data.hadoop.convert.support.BooleanWritableBooleanConverter;
import org.springframework.data.hadoop.convert.support.ByteByteWritableConverter;
import org.springframework.data.hadoop.convert.support.ByteWritableByteConverter;
import org.springframework.data.hadoop.convert.support.DoubleDoubleWritableConverter;
import org.springframework.data.hadoop.convert.support.DoubleWritableDoubleConverter;
import org.springframework.data.hadoop.convert.support.FloatFloatWritableConverter;
import org.springframework.data.hadoop.convert.support.FloatWritableFloatConverter;
import org.springframework.data.hadoop.convert.support.IntWritableIntegerConverter;
import org.springframework.data.hadoop.convert.support.IntegerIntWritableConverter;
import org.springframework.data.hadoop.convert.support.LongLongWritableConverter;
import org.springframework.data.hadoop.convert.support.LongWritableLongConverter;
import org.springframework.data.hadoop.convert.support.StringTextConverter;
import org.springframework.data.hadoop.convert.support.TextStringConverter;
