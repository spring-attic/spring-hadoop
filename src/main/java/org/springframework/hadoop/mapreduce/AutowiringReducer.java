 ...
 * 
 */
public class AutowiringReducer<KI, VI, KO, VO> extends Reducer<KI, VI, KO, VO> {
	
	private Reducer<KI, VI, KO, VO> delegate;
	
	protected void setup(Context context) throws IOException, InterruptedException {
		@SuppressWarnings("unchecked")
		Reducer<KI, VI, KO, VO> delegate = HadoopApplicationContextUtils.getBean(context.getConfiguration(), Reducer.class);
