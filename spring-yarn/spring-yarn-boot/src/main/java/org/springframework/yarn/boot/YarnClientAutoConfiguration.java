...
public class YarnClientAutoConfiguration {
	...
	private static String[] createMasterCommands(SpringYarnClientProperties sycp) throws Exception {
		...
		} else if (StringUtils.hasText(sycp.getRunnerClazz())) {
			factory.setRunnerClazz(sycp.getRunnerClazz());
		...
		// TODO: change this to map in yml when
		// xd gets into boot M8
		if (sycp.getArguments() != null) {

			Properties arguments = new Properties();
			for (String arg : sycp.getArguments()) {
