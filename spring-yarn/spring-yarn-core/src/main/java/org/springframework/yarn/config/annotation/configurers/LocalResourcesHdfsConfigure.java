...
public interface LocalResourcesHdfsConfigure extends AnnotationConfigurerBuilder<YarnResourceLocalizerConfigure> {
	...
	LocalResourcesHdfsConfigure hdfs(String dir, String file);

	LocalResourcesHdfsConfigure hdfs(String path, LocalResourceType type);

	LocalResourcesHdfsConfigure hdfs(String dir, String file, LocalResourceType type);
