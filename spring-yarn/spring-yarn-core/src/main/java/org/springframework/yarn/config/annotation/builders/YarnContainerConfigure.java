...
public interface YarnContainerConfigure {
	 ...
	 * @return {@link YarnContainerConfigure} for chaining
	 */
	YarnContainerConfigure containerClass(Class<? extends YarnContainer> clazz);

	YarnContainerConfigure containerClass(String clazz);
	 ...
	 * @return {@link YarnContainerConfigure} for chaining
	 */
	YarnContainerConfigure containerRef(YarnContainer ref);
