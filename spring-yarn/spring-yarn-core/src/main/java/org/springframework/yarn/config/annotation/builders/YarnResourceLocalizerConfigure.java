...
public interface YarnResourceLocalizerConfigure {
	 ...
	 * </pre>
	 *
	 * @return {@link LocalResourcesCopyConfigure} for chaining
	 * @throws Exception if error occurred
	 */
	LocalResourcesCopyConfigure withCopy() throws Exception;
	 ...
	 * @throws Exception if error occurred
	 */
	LocalResourcesHdfsConfigure withHdfs() throws Exception;
