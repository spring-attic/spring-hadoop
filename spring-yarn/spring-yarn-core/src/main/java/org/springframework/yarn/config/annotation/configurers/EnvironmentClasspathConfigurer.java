...
public class EnvironmentClasspathConfigurer
	...
	@Override
	public EnvironmentClasspathConfigure entries(List<String> entries) {
	...
	@Override
	public EnvironmentClasspathConfigure includeBaseDirectory(boolean includeBaseDirectory) {
